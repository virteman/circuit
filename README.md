...
[![GoDoc](https://godoc.org/github.com/virteman/circuit?status.svg)](https://godoc.org/github.com/virteman/circuit)
...
There are a large number of examples on the [godoc](https://godoc.org/github.com/virteman/circuit#pkg-examples) that are
...
## [Hello world circuit](https://godoc.org/github.com/virteman/circuit#example-Manager-MustCreateCircuit-Helloworld)
...
## [Hello world fallback](https://godoc.org/github.com/virteman/circuit#example-Circuit-Execute-Fallbackhelloworld)
...
## [Running inside a Goroutine](https://godoc.org/github.com/virteman/circuit#example-Circuit-Go)
...
## [Hystrix Configuration](https://godoc.org/github.com/virteman/circuit/closers/hystrix#example-ConfigFactory-Configure)
...
## [Enable dashboard metrics](https://godoc.org/github.com/virteman/circuit/metriceventstream#example-MetricEventStream)
...
## [Enable expvar](https://godoc.org/github.com/virteman/circuit#example-Manager-Var)
...
## [Custom metrics](https://godoc.org/github.com/virteman/circuit#example-Config--Custommetrics)
...
## [Panics](https://godoc.org/github.com/virteman/circuit#example-Circuit-Execute-Panics)
...
## [Runtime configuration changes](https://godoc.org/github.com/virteman/circuit/closers/hystrix#example-Closer-SetConfigThreadSafe)
...
## [Not counting early terminations as failures](https://godoc.org/github.com/virteman/circuit#example-Circuit--Noearlyterminate)
...
## [Configuration factories](https://godoc.org/github.com/virteman/circuit#example-CommandPropertiesConstructor)
...
## [StatsD configuration factory](https://godoc.org/github.com/virteman/circuit/metrics/statsdmetrics#example-CommandFactory-CommandProperties)
...
## [Service health tracking](https://godoc.org/github.com/virteman/circuit/metrics/responsetimeslo#example-Factory)
...
## [Not counting user error as a fault](https://godoc.org/github.com/virteman/circuit#example-BadRequest)
...
# [Benchmarking](https://github.com/virteman/circuit/blob/master/benchmarking/benchmark_hystrix_test.go)
...
goos: darwin
goarch: amd64
pkg: github.com/virteman/circuit/benchmarking
...
PASS
ok      github.com/virteman/circuit/benchmarking   59.518s
```
...
# [Development](https://github.com/virteman/circuit/blob/master/Makefile)

Make sure your tests pass with `make test` and your lints pass with `make lint`.

# [Example](https://github.com/virteman/circuit/blob/master/example/main.go)
